    ...
    SignInManager<ApplicationUser> signInManager) : Controller
{
    ...
    private readonly IAuthenticationSchemeProvider _schemeProvider = sp.GetRequiredService<IAuthenticationSchemeProvider>();
    private readonly IAuthenticationHandlerProvider _handlerProvider = sp.GetRequiredService<IAuthenticationHandlerProvider>();
    ...
    private async Task<LoginViewModel> BuildLoginViewModelAsync(string returnUrl)
    {
        ...
        if (context?.IdP != null && await _schemeProvider.GetSchemeAsync(context.IdP) != null)
        {
            ...
            if (!local)
            {
                var externalProvider = new ExternalProvider { AuthenticationScheme = context.IdP };
                vm.ExternalProviders = [externalProvider];
            }
